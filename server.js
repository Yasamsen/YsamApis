...
const { autoAuthByIp } = require('./middleware/ipAuth');
...
// Auto identify user by IP (replaces Google OAuth)
app.use(autoAuthByIp);
...
async function start() {
  try {
    ...
    app.listen(PORT, () => {
      ...
      console.log(`[SamApi] Auth mode: IP-based (no Google OAuth)`);
    });
  } catch (err) {
