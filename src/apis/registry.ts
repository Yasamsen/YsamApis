...
{
  slug: 'tempmail-generate',
  name: 'TempMail — Generate Email',
  description: 'Generate alamat email sementara (temporary email) secara acak.',
  category: 'Tempmail',
  method: 'GET',
  endpoint: '/api/tempmail/generate',
  icon: 'Mail',
  parameters: [],
  responseExample: { success: true, email: 'randomuser123@tempdomain.com' },
  responseFields: [
    { name: 'success', type: 'boolean', description: 'Whether the request succeeded.' },
    { name: 'email', type: 'string', description: 'Alamat email sementara yang dihasilkan.' },
  ],
  exampleRequest: 'https://samapi.example.com/api/tempmail/generate',
},
{
  slug: 'tempmail-custom',
  name: 'TempMail — Custom Email',
  description: 'Buat alamat email sementara dengan prefix dan domain custom pilihan sendiri.',
  category: 'Tempmail',
  method: 'GET',
  endpoint: '/api/tempmail/custom',
  icon: 'Mail',
  parameters: [
    { name: 'prefix', type: 'string', required: true, description: 'Nama depan email (sebelum @).', example: 'testuser123' },
    { name: 'domain', type: 'string', required: true, description: 'Domain email yang dipakai.', example: 'georgefletcher.org.uk' },
  ],
  responseExample: { success: true, email: 'testuser123@georgefletcher.org.uk' },
  responseFields: [
    { name: 'success', type: 'boolean', description: 'Whether the request succeeded.' },
    { name: 'email', type: 'string', description: 'Alamat email custom yang dibuat.' },
  ],
  exampleRequest: 'https://samapi.example.com/api/tempmail/custom?prefix=testuser123&domain=georgefletcher.org.uk',
},
{
  slug: 'tempmail-inbox',
  name: 'TempMail — Check Inbox',
  description: 'Cek pesan masuk (inbox) dari alamat temporary email yang sudah dibuat.',
  category: 'Tempmail',
  method: 'GET',
  endpoint: '/api/tempmail/inbox',
  icon: 'Mail',
  parameters: [
    { name: 'email', type: 'string', required: true, description: 'Alamat temp email yang ingin dicek inbox-nya.', example: 'testuser123@georgefletcher.org.uk' },
  ],
  responseExample: { success: true, emails: [] },
  responseFields: [
    { name: 'success', type: 'boolean', description: 'Whether the request succeeded.' },
    { name: 'emails', type: 'array', description: 'Daftar pesan masuk di inbox.' },
  ],
  exampleRequest: 'https://samapi.example.com/api/tempmail/inbox?email=testuser123@georgefletcher.org.uk',
},
{
  slug: 'tempmail-domains',
  name: 'TempMail — List Domains',
  description: 'Ambil daftar domain yang tersedia untuk membuat temporary email custom.',
  category: 'Tempmail',
  method: 'GET',
  endpoint: '/api/tempmail/domains',
  icon: 'Mail',
  parameters: [],
  responseExample: { success: true, domains: ['georgefletcher.org.uk', 'tempdomain.com'] },
  responseFields: [
    { name: 'success', type: 'boolean', description: 'Whether the request succeeded.' },
    { name: 'domains', type: 'array', description: 'Daftar domain yang tersedia.' },
  ],
  exampleRequest: 'https://samapi.example.com/api/tempmail/domains',
},
  {
    slug: 'instagram',
