...
if (!isDocsPage) {
  ...
  const apiTemplate =
    document.getElementById("apiTemplate");
  ...
  function renderHomeApis(list) {
    ...
    list.forEach(api => {
      ...
      const card =
        apiTemplate.content.cloneNode(true);
  ...
  async function initHome() {
    ...
    try {
      ...
      const totalElement =
        document.getElementById("totalApi");

      const onlineElement =
        document.getElementById("onlineApi");
...
if (isDocsPage) {
  ...
  const sidebar =
    document.getElementById("apiSidebar");

  const sidebarCount =
    document.getElementById("sidebarCount");

  const docsSearch =
    document.getElementById("docsSearch");

  const docsSearchMobile =
    document.getElementById("docsSearchMobile");

  const docsEmpty =
    document.getElementById("docsEmpty");

  const documentation =
    document.getElementById("apiDocumentation");

  const docMethod =
    document.getElementById("docMethod");
  ...
  const docEndpoint =
    document.getElementById("docEndpoint");

  const tryMethod =
    document.getElementById("tryMethod");

  const tryUrl =
    document.getElementById("tryUrl");

  const responseExample =
    document.getElementById("responseExample");
  ...
  const docUrlCopy =
    document.getElementById("docUrlCopy");
  ...
  const tryApiBtn =
    document.getElementById("tryApiBtn");
  ...
  const tryResult =
    document.getElementById("tryResult");

  const responseCode =
    document.getElementById("responseCode");
    ...
    list.forEach(api => {
      ...
      button.addEventListener(
        ...
        () => {
          ...
          mobileApiList.classList.remove(
            "open"
          );
      ...
      mobileApiList.appendChild(button);
  ...
  docsSearch?.querySelector("input")
    ?.addEventListener(
      "input",
      event => {
  ...
  document.addEventListener(
    ...
    event => {
      ...
      if (
        !mobileApiButton.contains(
          event.target
        ) &&
        !mobileApiList.contains(
          event.target
        )
      ) {
  ...
  async function initDocs() {
    ...
    try {
      ...
      renderSidebar(data.apis);
      renderMobileList(data.apis);
